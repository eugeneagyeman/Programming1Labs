...
public class Lab6Part1Test {
    ...
    void wolfMakeNoiseTest() {
        ...
        Assertions.assertTrue(output.length()>0, "Testing that noise is printed");
    ...
    void wolfMethodsTest() {
        ...
        Assertions.assertFalse(cm.contains("getName"), "Testing that the getName method is not in the Wolf class");
        Assertions.assertFalse(cm.contains("getAge"), "Testing that the getAge method is not in the Wolf class");
        Assertions.assertTrue(cm.contains("makeNoise"), "Testing that the makeNoise method is in the Wolf class");
    }
    ...
    void wolfAnimalMethodsTest() {
        ...
        Assertions.assertTrue(scm.contains("getName"), "Testing that the getName method is in the Animal class");
        Assertions.assertTrue(scm.contains("getAge"), "Testing that the getAge method is in the Animal class");
        Assertions.assertFalse(scm.contains("makeNoise"), "Testing that the makeNoise method is not in the Animal class");
    }
    ...
    void wolfFieldsTest() {
        ...
        Assertions.assertEquals(0, classfields.length, "Testing that there are no class fields in the Wolf class");
        Assertions.assertTrue(fields.length>0, "Testing that there are class fields in the Animal class");
